...
class VendorResetPasswordController extends Controller
{
    ...
    {
        return view('auth.vendor_passwords.reset')->with(
    ...
    public function reset(Request $request)
    {
        ...
        $response = $this->broker('vendor')->reset(
    ...
    public function redirectPath()
    {
        ...
        return property_exists($this, 'redirectTo') ? $this->redirectTo : '/vendors.dashboards';
    }
