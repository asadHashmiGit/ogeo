...
class PurchaseOrderCreatedNApprovedVendorNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                    ...
                    ->line('A new purchase order has been created and requiring your acceptance.')
