...
class PurchaseOrderCancellationValidationNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                    ->subject('Purchase Order Cancellation Request Validation Required.')
                    ->greeting($greeting)
                    ->salutation('Kind Regards,')
                    ->line('A Purchase Order Cancellation Request has been approved and requiring your validation.')
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'notification_name' => 'Purchase Order Cancellation Request Validation',
        ];
    }
}
