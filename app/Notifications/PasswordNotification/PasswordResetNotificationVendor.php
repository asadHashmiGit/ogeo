...
class PasswordResetNotificationVendor extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $urlToResetForm = "/vendor_password_set/?token=". $this->token;
        return (new MailMessage)
            ->subject('Password Reset Notification')
            ->greeting($greeting)
            ->line('Please Click on the Link Below to Reset Your Password!')
            ->action(('Reset Password'), url($urlToResetForm))
