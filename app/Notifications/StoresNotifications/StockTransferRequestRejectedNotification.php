...
class StockTransferRequestRejectedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        return [
            'stock_tranfer_request_id' => $this->StockTransferRequest->id,
            'class_name' => 'StockTransferRequest',
            'notification_name' => 'Stock Transfer Request Rejection',
        ];
    }
}
