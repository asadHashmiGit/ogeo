...
class StockTransferRequestValidationNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                    ->subject('Stock Transfer Request Validation Required.')
                    ->greeting($greeting)
                    ->salutation('Kind Regards,')
                    ->line('A Stock Transfer request has been approved and requiring your validation.')
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'notification_name' => 'Stock Transfer Request Validation',
        ];
    }
}
