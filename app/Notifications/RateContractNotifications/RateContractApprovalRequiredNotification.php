...
class RateContractApprovalRequiredNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                    ->subject('Rate Contract Required Approval.')
                    ->greeting($greeting)
                    ->salutation('Kind Regards,')
                    ->line('A pending Rate Contract requiring your approval.')
