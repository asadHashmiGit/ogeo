...
class RateContractVendorRejectedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                    ->subject('Vendor Rejected Rate Contract.')
                    ->greeting($greeting)
                    ->salutation('Kind Regards,')
                    ->line('Rate Contract has been rejected by the Vendor.')
