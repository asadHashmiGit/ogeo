    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <table ref="NewRCApprovals" id="NewRCApprovals" class="display responsive table table-bordered table-hover" style="width:100%">
                        <thead>
                            <tr>
                                <th>RC #</th>
                                <th>Created By</th>
...
<script>
    ...
    export default {
        ...
        mounted(){
            ...
            const table = $('#NewRCApprovals').DataTable({
                stateSave:  true,
                responsive: true,
                colReorder: true,
                processing: true,
                serverSide: true,
                ajax: 'http://' + window.location.host + '/api/data/get_rate_contract_approval_list',
                columns: [
                    { data: 'id', name: 'id' },
            ...
            $('tbody', this.$refs.NewRCApprovals).on('click', '.view-placeholder', function(){
                var $this = $(this);
                var RecordID = $(this).data('recordid');
                self.showViewModal(RecordID);
            });

            $('tbody', this.$refs.NewRCApprovals).on('click', '.edit-placeholder', function(){
                var $this = $(this);
                var RecordID = $(this).data('recordid');
