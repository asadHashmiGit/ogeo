<template>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4>Stock Transfer Request Approvals List</h4>
                </div>
                <div class="card-body">
                    <table ref="StockTransferRequestApprovals" id="StockTransferRequestApprovals" class="display responsive table table-bordered table-hover" style="width:100%">
                        <thead>
                            <tr>
                                <th>Request #</th>
                                <th>Created By</th>
        ...
        <div id="StoreTransferRequestValidationModalView" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="StoreTransferRequestValidationModalView" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div  class="modal-header">
                        <h4 class="modal-title">Stock Transfer Request#: {{ ViewModalInfo.stock_transfer_request_group_id }}-{{ ViewModalInfo.stock_transfer_request_ingroup_id }}</h4>
                    ...
                    <div class="modal-body" v-if="viewDataLoaded">
                        <div class="row">
                            <div class="col-lg-6">
                                <table class="table">
                                    <tr>
                                        <td style="width: 40%"><b>Stock Transfer Request#:</b></td>
                                        <td>{{ ViewModalInfo.stock_transfer_request_group_id }}-{{ ViewModalInfo.stock_transfer_request_ingroup_id }}</td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="col-lg-6">
                                <table class="table">
                                    <tr>
                                        ...
                                        <td>{{ ViewModalInfo.from_project.title }}</td>
                                    </tr>
                                    <tr>
                                        <td><b>To Project Date: </b></td>
                                        <td>{{ ViewModalInfo.to_project.title }}</td>
                                    </tr>
                                    <tr>
        ...
        <div id="StoreTransferRequestValidationModalEdit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="StoreTransferRequestValidationModalEdit" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div  class="modal-header">
                        <h4 class="modal-title">Stock Transfer Request#: {{ ViewModalInfo.stock_transfer_request_group_id }}-{{ ViewModalInfo.stock_transfer_request_ingroup_id }}</h4>
                    ...
                    <div class="modal-body" v-if="editDataLoaded">
                        <div class="row">
                            <div class="col-lg-6">
                                <table class="table">
                                    <tr>
                                        <td style="width: 40%"><b>Stock Transfer Request# (ID):</b></td>
                                        <td>Request#: {{ ViewModalInfo.stock_transfer_request_group_id }}-{{ ViewModalInfo.stock_transfer_request_ingroup_id }}</td>
                                    </tr>
                                    <tr>
                                        <td><b>Created By: </b></td>
                            ...
                            <div class="col-lg-6">
                                <table class="table">
                                    <tr>
                                        <td><b>From Store: </b></td>
                                        <td>{{ EditModalInfo.from_project.title }}</td>
                                    </tr>
                                    <tr>
                                        <td><b>To Project Date: </b></td>
                                        <td>{{ EditModalInfo.to_project.title }}</td>
                                    </tr>
                                    <tr>
                                        <td><b>Stock Item ID: </b></td>
                        ...
                        <el-form :model="ValidationInfo" class="demo-form-inline" :rules="rules" ref="StockTransferRequestValidationForm">
                            <div v-if="ItemExistsAsStockItem == 'Yes'" class="row">
                                <div class="col-lg-12">
                                    <div class="col-lg-12">
                                        <hr>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="grid-content">
                                            <el-form-item label="Enter Bin Location" prop="Bin">
                                                <el-input placeholder="Enter Bin Location" v-model="ValidationInfo.Bin">
                                                </el-input>
                                            </el-form-item>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="grid-content">
                                            <el-form-item label="Enter Shelf Location" prop="Shelf">
                                                <el-input placeholder="Enter Shelf Location" v-model="ValidationInfo.Shelf">
                                                </el-input>
                                            </el-form-item>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="grid-content">
                                            <el-form-item label="Enter Rack Location" prop="Rack">
                                                <el-input placeholder="Enter Rack Location" v-model="ValidationInfo.Rack">
                                                </el-input>
                                            </el-form-item>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="grid-content">
                                            <el-form-item label="Enter Area Location" prop="Area">
                                                <el-input placeholder="Enter Area Location" v-model="ValidationInfo.Area">
                                                </el-input>
                                            </el-form-item>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="grid-content">
                                            <el-form-item label="Enter Alley Location" prop="Alley">
                                                <el-input placeholder="Enter Alley Location" v-model="ValidationInfo.Alley">
                                                </el-input>
                                            </el-form-item>
                                        </div>
                                    </div>
    ...
    export default {
        ...
        methods: {
            showViewModal(elquentClass, recordId){
                this.ViewModalInfo = {};
                axios.post('/api/data/get_stock_transfer_request_record_details', [elquentClass, recordId])
                    .then((response) => {
                        this.ViewModalInfo = response.data;
                        console.log(this.ViewModalInfo);
                        this.viewDataLoaded = true;
                        $('#StoreTransferRequestValidationModalView').modal('toggle');
                    });
            ...
            showEditModal(elquentClass, recordId){
                ...
                axios.post('/api/data/get_stock_transfer_request_record_details', [elquentClass, recordId])
                    .then((response) => {
                        ...
                        this.ValidationInfo.StockTransferRequestId = this.EditModalInfo.id;
                        this.editDataLoaded = true;
                        $('#StoreTransferRequestValidationModalEdit').modal('toggle');
                    })
            ...
            DecisionApprove(){
                ...
                axios.post('/api/stores/validate_stock_transfer_request', this.ValidationInfo)
            ...
            DecisionReject(){
                ...
                this.$refs.StockTransferRequestValidationForm.validate((validation) => {
                    if(validation){
                        axios.post('/api/stores/validate_stock_transfer_request', this.ValidationInfo)
                            .then(function(response){
                                Swal({ 
        ...
        mounted(){
            ...
            const table = $('#StockTransferRequestApprovals').DataTable({
                stateSave:  true,
                responsive: true,
                colReorder: true,
                processing: true,
                serverSide: true,
                ajax: 'http://' + window.location.host + '/api/data/get_stock_transfer_request_list',
                columns: [
                    { data: 'id', name: 'id' },
                    { data: 'creator.name', name: 'creator.name' },
                    { data: 'from_project.title', name: 'from_project.title' },
                    { data: 'to_project.title', name: 'to_project.title' },
            ...
            $('tbody', this.$refs.StockTransferRequestApprovals).on('click', '.view-placeholder', function(){
                var $this = $(this);
                var RecordID = $(this).data('recordid');
                self.showViewModal(RecordID);
            });

            $('tbody', this.$refs.StockTransferRequestApprovals).on('click', '.edit-placeholder', function(){
                var $this = $(this);
                var RecordID = $(this).data('recordid');
            ...
            $('#StoreTransferRequestValidationModalEdit').on('hide.bs.modal', function (e) {
                        ...
                        Swal({
                          ...
                          cancelButtonText: 'Cancel'
                            ...
                            if (result.value) {
                                ...
                                self.ApprovedLines = [];
                                self.RejectedLines = [];
                                $("#StoreTransferRequestValidationModalEdit").modal('hide');
                            }
...
<style scoped>
    ...
    #StoreTransferRequestValidationModalView .modal-dialog {
        min-width:80%;
    }

    #StoreTransferRequestValidationModalEdit .modal-dialog {
        min-width:90%;
    }
