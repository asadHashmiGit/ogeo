        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4>Stock Item Purchase Enquiries List</h4>
                </div>
                <div class="card-body">
                    <table ref="table" id="StockItemsPurchaseEnquiriesList" class="display responsive table table-bordered table-hover" style="width:100%">
                        <thead>
                            <tr>
                                <th>Request #</th>
                                <th>GroupID</th>
...
<script>
    ...
    export default {
        ...
        mounted(){
            ...
            const table = $('#StockItemsPurchaseEnquiriesList').DataTable({
                fixedHeader: {
                    header: true,
                    headerOffset: 117
                },
