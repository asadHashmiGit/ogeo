    ...
    <div class="row">
        ...
        <div id="StoreItemReturnRequestValidationModalEdit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="StoreItemReturnRequestValidationModalEdit" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div  class="modal-header">
                        <h4 class="modal-title">Stock Item Return Request#: {{ EditModalInfo.stock_item_return_request_group_id }}-{{ EditModalInfo.stock_item_return_request_ingroup_id }}</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
...
<script>
    ...
    export default {
        name: 'stock-item-return-approval-list',
        data(){
            return{
                DataTable: "",
        ...
        methods: {
            ...
            showEditModal(elquentClass, recordId){
                ...
                axios.post('/api/data/get_stock_item_return_request_record_details', [elquentClass, recordId])
                    .then((response) => {
                        ...
                        this.ValidationInfo.StockItemReturnRequestId = this.EditModalInfo.id;
            ...
            DecisionApprove(){
                ...
                axios.post('/api/stores/validate_stock_item_return_request', this.ValidationInfo)
        ...
        mounted(){
            ...
            const table = $('#StockItemReturnRequestApprovals').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: 'http://' + window.location.host + '/api/data/get_stock_item_return_request_list',
                columns: [
