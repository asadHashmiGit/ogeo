            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body" v-if="editDataLoaded">
                        ...
                        <el-form :model="ValidationInfo" class="demo-form-inline" :rules="rules" ref="StockItemIssueRequestValidationForm">
                            <div class="row">
                                <div class="col-lg-12">
    ...
    export default {
        ...
        methods: {
            ...
            showEditModal(elquentClass, recordId){
                ...
                axios.post('/api/data/get_stock_item_issue_request_record_details', [elquentClass, recordId])
                    .then((response) => {
                        ...
                        this.ValidationInfo.StockItemIssueRequestId = this.EditModalInfo.id;
            ...
            DecisionApprove(){
                ...
                axios.post('/api/stores/validate_stock_item_issue_request', this.ValidationInfo)
        ...
        mounted(){
            ...
            const table = $('#StockItemIssuanceRequestApprovals').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: 'http://' + window.location.host + '/api/data/get_stock_item_issue_request_list',
                columns: [
            ...
            $('#StoreItemIssueRequestValidationModalEdit').on('hide.bs.modal', function (e) {
                        ...
                        Swal({
                          ...
                          cancelButtonText: 'Cancel'
                            ...
                            if (result.value) {
                                ...
                                self.ApprovedLines = [];
                                self.RejectedLines = [];
                                $("#StoreItemIssueRequestValidationModalEdit").modal('hide');
                            }
