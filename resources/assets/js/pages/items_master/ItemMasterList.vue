                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <template v-for="index in 20">    
                                                <span v-if="ViewModalInfo.item_template['field_'+(index)] !== 'Ogeo-None'">
                                                    <b>{{ ViewModalInfo.item_template['field_'+(index)] }}:</b> {{ ViewModalInfo['field_'+(index)] }} | 
                                                </span>
                                            </template>
                                        </td>
                                    </tr>
            ...
            setTimeout(() => {
                ...
                const table = $('#ItemsList').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'item_template.template_name', name: 'item_template.template_name' },
