        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                ...
                <div id="breadcrumb-title" class="col-md-12 col-lg-5 col-xlg-5 animated">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Request For Proposals</a></li>
                ...
                <div class="col-md-4 col-lg-7 col-xlg-7">
                    ...
                    <div v-if="currentUser.hasOwnProperty('RFQM')" style="padding: 1px 1px 1px 1px" class="col-lg-4 float-left">
                        <router-link style="margin: 1px 0px 1px 0px" class="btn btn-block waves-effect btn-success text-white" to="/app/quotations"> New Request for Proposals</router-link>
                    </div>

                    <div v-if="currentUser.hasOwnProperty('RFQM')" style="padding: 1px 1px 1px 1px" class="col-lg-4 float-left">
                        <router-link style="margin: 1px 0px 1px 0px" class="btn btn-block waves-effect btn-success text-white" to="/app/quotations/manage_quotations"> List of Requests for Proposals</router-link>
                    </div>
