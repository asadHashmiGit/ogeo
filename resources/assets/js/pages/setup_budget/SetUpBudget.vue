        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                ...
                <div class="col-md-4 col-lg-7 col-xlg-7">
                    ...
                    <div v-if="currentUser.hasOwnProperty('SUBO')" style="padding: 1px 1px 1px 1px" class="col-lg-4 float-left">
                        <router-link style="margin: 1px 0px 1px 0px" class="btn btn-block waves-effect btn-success text-white" to="/app/items_master"> Request To Update The <br> Set-Up Budget</router-link>
                    </div>

                    <div v-if="currentUser.hasOwnProperty('SUBO') || currentUser.hasOwnProperty('SUBV')" style="padding: 1px 1px 1px 1px" class="col-lg-4 float-left">
                        ...
                        <router-link style="margin: 1px 0px 1px 0px" class="btn btn-block waves-effect btn-success text-white" to="/app/items_master/requests_list"> List Of Requests To <br>Update Set-Up Budget</router-link>
                    </div>
                    ...
                    <!-- <div v-if="currentUser.hasOwnProperty('SUB')" style="padding: 1px 1px 1px 1px" class="col-lg-4 float-left">
...
<script>
    ...
    export default {
        ...
        beforeRouteEnter (to, from, next) {
            ...
            if(currentUser.hasOwnProperty('SUB') || currentUser.hasOwnProperty('SUBV')){
                //check with the backend if user has SAD privileges
                axios.get('/api/users/get_user_details')
                    .then(response => {
                        //console.log(response.data);
                        if(response.data.hasOwnProperty('SUB') || currentUser.hasOwnProperty('SUBV')){
                            next();
                        } else {
