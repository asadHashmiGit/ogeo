                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <table class="table">
                                    ...
                                    <tr v-if="ViewModalInfo.expected_price > 0">
                                        <td><b>Expected Cost: </b></td>
                                        <td>{{ formatPrice(ViewModalInfo.expected_price) }} {{ViewModalInfo.project.currency}}<br><small>From the selected Rates Contracts</small> </td>
                                    </tr>
