<template>
	...
	<div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4>Rate Contract Requests List</h4>
                </div>
                <div class="card-body">
                    <table ref="table" id="NewRateContractItemRequestList" class="responsive table table-bordered table-hover" style="width:100%">
                        <thead>
                            <tr>
                                <th>Request #</th>
                                <th>Grouping ID</th>
        ...
        <div id="RateContractItemRequestModalView" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="RateContractItemRequestModalView" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div  class="modal-header">
                        <h4 class="modal-title">Item Rate Contract Request Number: {{ ViewModalInfo.id }} (View)</h4>
                    ...
                    <div class="modal-body" v-if="viewDataLoaded">
                        <div class="row">
                            <div class="col-lg-6">
                                <table class="table">
                                    <tr>
                                        <td style="width: 40%"><b>Item Rate Contract Request Number (ID):</b></td>
        ...
        <div id="ItemRateContractRequestModalEdit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="ItemRateContractRequestModalEdit" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div  class="modal-header">
                        <h4 class="modal-title">Rate Contract Item Request: {{ EditModalInfo.id }} (Edit)</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <div class="modal-body" v-if="editDataLoaded">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <el-form :model="EditModalInfo" class="demo-form-inline" :rules="rules" ref="RateContractItemRequestEditForm">
			                        ...
			                        <el-row :gutter="20">
                                        ...
                                        <el-col :span="12">
                                            <div class="grid-content">
                                                <el-form-item label="Select Rate Contract Start Date" prop="RateContractStartPeriod">
                                                ...
                                                <span style="z-index: 1" class="mytooltip tooltip-effect-1">
                                                    ...
                                                    <el-date-picker
                                                      style="width: 100%"
                                                      v-model="EditModalInfo.rc_start_period"
                                                      type="date"
                                        ...
                                        <el-col :span="12">
                                            <div class="grid-content">
                                                <el-form-item label="Select Rate Contract End Date" prop="RateContractEndPeriod">
                                                ...
                                                <span style="z-index: 1" class="mytooltip tooltip-effect-1">
                                                    ...
                                                    <el-date-picker
                                                      style="width: 100%"
                                                      v-model="EditModalInfo.rc_end_period"
                                                      type="date"
                                        ...
                                        <el-col :span="24" >
                                            <el-form-item label="Delivery Location Name" prop="LocationName">
                                                <el-input type="text" placeholder="Enter Delivery Location Name" v-model="EditModalInfo.location_name"></el-input>
                                            </el-form-item>
                                        </el-col>
			                            ...
			                            <button type="button" @click="SubmitUpdateItemRateContractRequest" class="btn btn-success btn-block waves-effect text-center">Update Item Rate Contract Request</button>

			                            <el-col :span="24">
                                            <hr>
                                            <button type="button" @click="CancelItemRateContractRequest" class="btn btn-danger btn-block waves-effect text-center">Cancel Item Contract Rate Request</button>
                                        </el-col>
...
<script>
    ...
    export default {
        name: 'item-rate-contract-requests',
        data(){
            return{
                DataTable: "",
        ...
        methods: {
        	CancelItemRateContractRequest(){
                axios.post('/api/rate_contracts/cancel_rate_contract_item_request', {ItemRateContractRequestId: this.EditModalInfo.id})
                ...
                this.$nextTick(() => {
                    $('#ItemRateContractRequestModalEdit').modal('toggle');
            ...
            SubmitUpdateService() {
                ...
                this.RateContractAllItems.push(Object.assign({}, this.EditModalInfo));
            ...
            showViewModal(elquentClass, recordId){
                ...
                axios.post('/api/data/get_rate_contract_requests_record_details', [elquentClass, recordId])
                    .then((response) => {
                        ...
                        $('#RateContractItemRequestModalView').modal('toggle');
                    })
        ...
        mounted(){
            ...
            const table = $('#NewRateContractItemRequestList').DataTable({
                stateSave:  true,
                responsive: true,
                colReorder: true,
                processing: true,
                serverSide: true,
                ajax: 'http://' + window.location.host + '/api/users/get_users_rate_contract_requests',
                columns: [
                    { data: 'rate_contract_request_ingroup_id', name: 'rate_contract_request_ingroup_id' },
...
<style scoped>
    ...
    #RateContractItemRequestModalView .modal-dialog {
        min-width:80%;
    }

    #ItemRateContractRequestModalEdit .modal-dialog {
        min-width:80%;
    }
