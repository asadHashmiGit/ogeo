        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <div class="col-md-12 col-lg-5 col-xlg-5 align-self-center">
                    <h3 class="text-themecolor m-b-0 m-t-0">Quotations FAQs</h3>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">FAQs</a></li>
                        <li class="breadcrumb-item active">Quotations FAQs</li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Quotations Frequently Asked Questions</h4>
                            <h6 class="card-subtitle">Quotations Frequently Asked Questions</h6>
...
<script>
    ...
    export default{
        ...
        mounted(){
            ...
            axios.post('/api/system_management/get_faqs', ['Quotations FAQs'])
                .then((response) => {
