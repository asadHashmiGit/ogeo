/*
Template Name: Basic Function required to run the app
*/
...
export function CustomJs(){
	...
	$(function () {
        ...
        $(".fix-header .topbar .left-sidebar .fix-sidebar").stick_in_parent({
        ...
        /* Remove Token Once User is Close or Refresh the browser*/
